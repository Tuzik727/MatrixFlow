from Omega.src.Backend.DAO.Equations import EquationDAO
from Omega.src.Backend.DAO.Solutions import SolutionDAO
from Omega.src.Backend.DAO.Systems import SystemsDAO
from Omega.src.MatrixOperation.LinearSystem.SolveSystem import solve_system_2, solve_system_3, get_equation_coeffs, \
    solve_system_4
...
def insertLinearSystem(equations_str: str, userID: int):
    ...
    try:
        ...
        if num_rows == 2:
            ...
            raise ValueError("You have bad input(you might have minium two systems, there is example:\n"
                             "2x -1y = 4/n"
                             "1x + 1y = 2")
